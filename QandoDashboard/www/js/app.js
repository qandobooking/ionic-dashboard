...
angular.module('app', ['ionic', 'restangular', 'satellizer', 'angular-storage', 'validate-form', 'app.constants', 'app.satellizer', 'app.routing', 'app.network', 'ion-datetime-picker']).run(function ($ionicPlatform, $rootScope, Entities) {
